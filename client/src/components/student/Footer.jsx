...
const Footer = () => {
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full'>
      <div className='flex flex-col md:flex-row items-start px-4 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/10'>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright { new Date().getFullYear() } © GreatStack. All Right Reserved.</p>
    </footer>
  )
}
