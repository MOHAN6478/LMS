...
const MyEnrollments = () => {
  ...
  const [ progressArray, setProgressArray ] = useState([
    ...
    { lectureCompleted : 7, totalLecture : 8 },
    { lectureCompleted : 2, totalLecture : 6 },
    { lectureCompleted : 1, totalLecture : 10 },
    { lectureCompleted : 0, totalLecture : 1 },
    { lectureCompleted : 6, totalLecture : 3 },
    { lectureCompleted : 8, totalLecture : 2 },
    ...
    <>
      <div className='md:px-36 px-8 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10 '>
          <thead className='text-gray-900 border-b border-gray-500/70 text-sm text-left max-sm:hidden'>
            <tr>
